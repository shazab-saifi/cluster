...
export function NetworkDetailsForm({
  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      if (value.description !== (network.description ?? "")) {
      ...
      await mutation.mutateAsync(
        payload as { name: string; description: string; image?: string }
      );
        ...
        <FieldGroup>
          <div className="mx-auto w-fit">
            ...
            >
              <Avatar className="size-24">
                <AvatarImage
                  src={avatarPreview ?? network.image ?? undefined}
                  alt={network.name}
                />
          ...
          <form.Field name="description">
            {(field) => {
              ...
              return (
                <Field data-invalid={isInvalid}>
                  <FieldLabel htmlFor="network-description">
                    Description
                  </FieldLabel>
                  <Textarea
                  ...
                  {isInvalid && <FieldError errors={field.state.meta.errors} />}
                  <FieldDescription>
                    A brief description for your network.
                  </FieldDescription>
                </Field>
              );
            }}
